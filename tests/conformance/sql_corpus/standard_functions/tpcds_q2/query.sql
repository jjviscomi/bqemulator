...
wswscs AS (
  ...
  FROM wscs, `${DATASET}.date_dim` AS date_dim
...
FROM (
  SELECT
    ...
    wed_sales AS wed_sales1, thu_sales AS thu_sales1, fri_sales AS fri_sales1,
    sat_sales AS sat_sales1
  FROM wswscs, `${DATASET}.date_dim` AS date_dim
...
(
  SELECT
    ...
    wed_sales AS wed_sales2, thu_sales AS thu_sales2, fri_sales AS fri_sales2,
