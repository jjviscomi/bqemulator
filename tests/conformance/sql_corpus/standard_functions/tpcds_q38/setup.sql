-- TPC-DS Q38 setup — 3-way INTERSECT chain over (c_last_name, c_first_name,
-- d_date) across store/catalog/web. Spec params: d_month_seq 1200..1211.
...
INSERT INTO `${DATASET}.store_sales` VALUES
  -- Customer 1 buys at all 3 channels on (date 2451179)
  (2451179, 1),
  -- Customer 2 buys at store + catalog only
  (2451179, 2),
  -- Customer 3 buys at store only
  (2451179, 3),
  -- Customer 4 buys at all 3 channels on different dates
  (2451209, 4);
