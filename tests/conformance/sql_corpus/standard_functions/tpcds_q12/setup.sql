-- TPC-DS Q12 setup — web_sales ⋈ item ⋈ date_dim with item-revenue ratio via
-- SUM(ws_ext_sales_price) OVER (PARTITION BY i_class). Spec params:
...
INSERT INTO `${DATASET}.web_sales` VALUES
  ...
  (2451232, 1, NUMERIC "100.00"),
  (2451240, 1, NUMERIC  "60.00"),
  (2451250, 2, NUMERIC "200.00"),
  -- class=fiction: item 3 + item 4
  (2451240, 3, NUMERIC  "75.00"),
  (2451250, 4, NUMERIC "125.00"),
  -- class=lighting: item 5
  (2451262, 5, NUMERIC "160.00"),
