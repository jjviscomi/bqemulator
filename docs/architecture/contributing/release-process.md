...
2. **Pre-release doc sweep.** The release orchestrator only mutates
   ...
   | [`docs/index.md`](https://github.com/jjviscomi/bqemulator/blob/main/docs/index.md) — "Status" callout | The `**vX.Y.Z** — production-stable` version string in the landing-page Status admonition. Not covered by `bump_version.py`; update **every** release (it silently went stale through v1.1.0 + v1.1.1). |
